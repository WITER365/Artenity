...
export default function PaginaPrincipal() {
  ...
  const handleCompartir = async (idPublicacion: number) => {
    try {
      await compartirPublicacion(idPublicacion, mensajeCompartir);
      
      // Mostrar notificación
      const notificacionEvent = new CustomEvent('nuevaNotificacion', {
        detail: { mensaje: 'Publicación compartida exitosamente', tipo: 'exito' }
      });
                ...
                <div className="compartir-panel" onClick={(e) => e.stopPropagation()}>
                  <div className="compartir-header">
                    ...
                    <button 
                      ...
                      onClick={() => setCompartirAbierto(null)}
                    >
                      <X size={16} />
                    </button>
                  </div>
                  ...
                  <div className="compartir-interno">
                    ...
                    <button 
                      ...
                      onClick={() => handleCompartir(post.id_publicacion)}
                    >
                      <Share2 size={16} />
