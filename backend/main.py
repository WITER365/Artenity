...
def compartir_publicacion(
    ...
    try:
        ...
        nuevo_compartido = models.Compartido(
            ...
            id_publicacion=id_publicacion,
            tipo="perfil",  # Compartir en el perfil
            mensaje=mensaje or ""
        )
        ...
        if publicacion.id_usuario != current_user_id:
            notificacion = models.Notificacion(
                id_usuario=publicacion.id_usuario,
                tipo="compartido",
                mensaje=f"@{db.query(models.Usuario).filter(models.Usuario.id_usuario == current_user_id).first().nombre_usuario} compartió tu publicación",
                leido=False,
                id_referencia=id_publicacion
            )
            db.add(notificacion)
